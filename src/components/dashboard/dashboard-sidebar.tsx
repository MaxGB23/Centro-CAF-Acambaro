          ...
          <div className="flex items-center sm:shadow-md p-4 pl-5">
            <div className={`flex items-center ${sidebarOpen ? "space-x-4" : ""}`}>
              ...
              >
                {/* {session ? ( */}
                  <>
                    <h2 className="text-lg font-semibold whitespace-nowrap"> Luis Mario </h2>
                    <p className="text-[13px] mb-[0.5px] text-gray-500 dark:text-gray-400 whitespace-nowrap">Fisioterapeuta</p>
                  </>
                {/* ) : (
